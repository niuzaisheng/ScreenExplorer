# Copy from https://github.com/barneygale/asyncvnc
...
class Client:
    ...
    async def read(self) -> UpdateType:
        ...
        if update_type is UpdateType.CLIPBOARD:
            ...
            print(f'[asyncvnc] Received clipboard, text: {self.clipboard.text}')
        ...
        elif update_type is UpdateType.BELL:
            print('[asyncvnc] Received bell')
            pass

        else:
            raise UnknownUpdateTypeError(f'unknown update type: {update_type}')
